    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-3 items-center justify-center w-full mt-2">
          <div className="w-full text-center px-1 py-3 bg-sky-50/60 border border-sky-200/50 rounded-lg overflow-hidden">
            <span className="text-[18px] md:text-[20px] font-bold text-gray-700 font-sans break-words">
