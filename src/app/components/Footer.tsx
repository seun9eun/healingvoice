...
export function Footer() {
  ...
  return (
    <footer className="w-full px-4 md:px-[10vw] py-8 md:py-[2.5vw]">
      <div className="w-full max-w-[1536px] mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-[1.6667vw] px-0 md:px-[0.8333vw]">
        {/* 좌측: 로고 + 연락처 */}
        <div className="flex flex-col items-center md:items-start gap-3 md:gap-[0.8333vw] w-full md:flex-1 min-w-0">
          <img
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 md:gap-[0.4167vw]">
        ...
        <div className="flex flex-col items-center md:items-end gap-3 md:gap-[0.8333vw] w-full md:flex-1 min-w-0">
          ...
          <p className="text-xs md:text-[0.6771vw] leading-5 text-[#C2CAD9]">
