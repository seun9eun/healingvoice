...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* 콘텐츠 */}
      <div className="relative z-10 w-full max-w-4xl mx-auto px-10 text-center pt-28 pb-24 md:absolute md:w-[45vw] md:max-w-none md:mx-0 md:px-[2.0833vw] md:pt-0 md:pb-0 md:left-1/2 md:-translate-x-1/2 md:top-[14.5833vw]">
        <motion.div
