        ...
        <div className="max-w-screen-lg mx-auto flex flex-col items-center gap-4">
          ...
          <div className="flex justify-center w-50">
            <img
              src={img_tag}
              alt={t("hero.tagline")}
              className="w-full max-w-[144px] md:max-w-[192px] h-auto object-contain"
            />
          </div>
          ...
          <div className="text-[#101828] max-w-4xl mx-auto space-y-2 text-center"> 
            ...
            {/* 첫 번째 줄 */}
            <p className="text-[18px] md:text-[28px] font-semibold leading-snug md:leading-[36px] tracking-normal break-words break-keep whitespace-pre-wrap">
            ...
            {/* 두 번째 줄 */}
            <p className="text-[20px] md:text-[28px] font-semibold leading-snug md:leading-[36px] tracking-normal break-words break-keep whitespace-pre-wrap">
              {t("hero.descPart4")}
            </p>
          ...
          <div className="bg-[#e9ed7f] rounded-[10px] shadow-sm px-[24px] py-[20px]">
            <p className="font-medium text-[#101828] text-lg md:text-2xl text-center break-words break-keep whitespace-pre-wrap">
              {t("hero.period")}
            </p>
          </div>
