      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="relative z-10 flex flex-col gap-10">
            ...
            {/* Header: big card 안내 문구 */}
            <div className="flex flex-col gap-6">
              <div className="flex py-2 items-center gap-4">

                {/* 아이콘 박스 (64px 가이드 반영) */}
                <div className="flex w-16 h-16 shrink-0 justify-center items-center aspect-square">
                  <img src={PinImg} alt="Pin" className="w-full h-full object-contain" />
                </div>

                {/* 타이틀 스타일 (36px, font-800, Blue-500) */}
                <h2 className="text-[#44A9FF] font-nanumSquareNeo text-[24px] md:text-[36px] font-extrabold leading-[28.5px] font-style-normal break-keep">
                  {t('checklist.title')}
                </h2>
                ...
                <div className="text-[19px] md:text-[21px] break-keep">
                  {lang === 'ko' ? (
                    <p className="text-gray-800 font-medium">
                      2.<span className="text-[#44A9FF] font-bold">{t('checklist.item2_1')}{t('checklist.item2_bold')}</span>{t('checklist.item2_2')}
                    </p>
                  ) : (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#F8FDFF] border border-[#E0F2FE] rounded-2xl p-5 md:p-7 flex flex-col gap-6">
                <div className="flex items-center gap-2 self-stretch">
                  ...
                  {/* 타이틀 스타일 */}
                  <h3 className="text-[#101828] font-nanumSquareNeo text-[20px] md:text-[24px] font-bold leading-[28.5px] font-style-normal">
              ...
              <div className="bg-[#F8FDFF] border border-[#E0F2FE] rounded-2xl p-5 md:p-7 flex flex-col gap-6">
                <div className="flex items-center gap-2 self-stretch">
                  ...
                  {/* 타이틀 스타일 */}
                  <h3 className="text-[#101828] break-keep font-nanumSquareNeo text-[20px] md:text-[24px] font-bold leading-[28.5px] font-style-normal">
                  ...
                  <div className="space-y-2">
                    {[1, 2, 3].map((num) => (
                      <div key={num} className="bg-white border border-[#155dfc]/5 rounded-xl p-3.5">
                        <p className="whitespace-pre-line text-gray-600 text-[18px] md:text-[21px] font-medium leading-tight md:leading-[30px] break-all">
