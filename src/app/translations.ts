export const translations = {
  ko: {
    ...
    checklist: {
      ...
      item2_2: "대로 작성했는지 확인해 주세요.",
      subject: {
        title: "메일 제목 예시",
        format: "[힐링보이스 지원] 이름 + 생년(연락처 뒷자리)",
        example: "[힐링보이스 지원] 김찬송95(1234)",
      },
      filename: {
        title: "첨부 파일명 예시",
        format: "이름 + 생년(연락처 뒷자리)_파일명",
        file1: "김찬송95(1234)_참가지원서.hwp",
        file2: "김찬송95(1234)_노래제목.mp4",
        file3: "김찬송95(1234)_사진1.jpg",
      },
    },
    songs: {
  ...
  en: {
    ...
    info: {
      ...
      awards: {
        ...
        desc: "Introducing the exclusive benefits for our Winner and the Top 7—Apply now!",
        grandPrize: {
          badge: "Grand Prize",
