...
//
// photo/photoModal 경로의 번호는 이 배열의 인덱스와 1:1로 대응한다(voice_01 = 배열 첫 번째).
// 이미지는 scripts/build-voice-images.mjs가 원본(저장소 밖 _assets/voices_original,
// 모달은 _assets/voices_modal_original)에서 만든 것이라, 이름을 바꾸려면 스크립트의
// ORDER 배열도 같이 고쳐야 한다. 모달 이미지는 `--modal` 플래그로 따로 빌드한다.
//
// 이름(영문)과 소개글은 기획 구글시트 두 번째 탭에서 가져왔다(2026-09-09).
// descKo/descEn은 카드에는 안 쓰인다 — Figma 카드에는 이름만 있고 소개글이 없다. 모달에서만 쓴다.
//
// [줄바꿈 규칙] 소개글의 "/"는 줄바꿈 자리다. Figma가 폭에 맡기지 않고 수동 개행을 쓰기 때문에
// (2026-09-10 확인) 폭 계산으로는 같은 자리에서 끊을 수 없다. 원하는 자리에 "/"를 넣으면 된다.
//   예) "세계 무대를 누비는 / 대한민국 오페라의 얼굴"
// "/"가 없으면 한 줄로 두고, 폭이 넘칠 때만 어절 단위로 자동으로 접힌다.
export interface Voice {
  ...
  photo: string;
  photoMobile?: string; // 모바일 카드용 — PC보다 크게 확대해 얼굴 위주로 잡힌 별도 크롭
  photoModal?: string; // 모달용 사진 — 카드와 다른 컷이다(카드=손 모은 포즈, 모달=턱 괴는 포즈)
}
...
export const VOICES_DATA: Voice[] = [
  {
    ...
    photoMobile: "/images/voices/mobile/voice_01.webp",
    photoModal: "/images/voices/modal/voice_01.webp",
  },
  {
    id: 2,
    nameKo: "김성신",
    ...
    photoMobile: "/images/voices/mobile/voice_02.webp",
    photoModal: "/images/voices/modal/voice_02.webp",
  },
  {
    id: 3,
    nameKo: "김신의",
    ...
    photoMobile: "/images/voices/mobile/voice_03.webp",
    photoModal: "/images/voices/modal/voice_03.webp",
  },
  {
    id: 4,
    nameKo: "김예은",
    ...
    photoMobile: "/images/voices/mobile/voice_04.webp",
    photoModal: "/images/voices/modal/voice_04.webp",
  },
  {
    id: 5,
    nameKo: "김하준",
    ...
    photoMobile: "/images/voices/mobile/voice_05.webp",
    photoModal: "/images/voices/modal/voice_05.webp",
  },
  {
    id: 6,
    nameKo: "김호준",
    ...
    photoMobile: "/images/voices/mobile/voice_06.webp",
    photoModal: "/images/voices/modal/voice_06.webp",
  },
  {
    id: 7,
    nameKo: "나시온",
    ...
    photoMobile: "/images/voices/mobile/voice_07.webp",
    photoModal: "/images/voices/modal/voice_07.webp",
  },
  {
    id: 8,
    nameKo: "라이야",
    ...
    photoMobile: "/images/voices/mobile/voice_08.webp",
    photoModal: "/images/voices/modal/voice_08.webp",
  },
  {
    id: 9,
    nameKo: "림팍",
    ...
    photoMobile: "/images/voices/mobile/voice_09.webp",
    photoModal: "/images/voices/modal/voice_09.webp",
  },
  {
    id: 10,
    ...
    photoMobile: "/images/voices/mobile/voice_10.webp",
    photoModal: "/images/voices/modal/voice_10.webp",
  },
  {
    id: 11,
    nameKo: "문은수",
    ...
    photoMobile: "/images/voices/mobile/voice_11.webp",
    photoModal: "/images/voices/modal/voice_11.webp",
  },
  {
    id: 12,
    nameKo: "박연홍",
    ...
    photoMobile: "/images/voices/mobile/voice_12.webp",
    photoModal: "/images/voices/modal/voice_12.webp",
  },
  {
    id: 13,
    nameKo: "박예음",
    ...
    photoMobile: "/images/voices/mobile/voice_13.webp",
    photoModal: "/images/voices/modal/voice_13.webp",
  },
  {
    id: 14,
    nameKo: "석상은",
    ...
    photoMobile: "/images/voices/mobile/voice_14.webp",
    photoModal: "/images/voices/modal/voice_14.webp",
  },
  {
    id: 15,
    nameKo: "아삽",
    ...
    photoMobile: "/images/voices/mobile/voice_15.webp",
    photoModal: "/images/voices/modal/voice_15.webp",
  },
  {
    id: 16,
    nameKo: "예잔",
    ...
    photoMobile: "/images/voices/mobile/voice_16.webp",
    photoModal: "/images/voices/modal/voice_16.webp",
  },
  {
    id: 17,
    nameKo: "유난이",
    ...
    photoMobile: "/images/voices/mobile/voice_17.webp",
    photoModal: "/images/voices/modal/voice_17.webp",
  },
  {
    id: 18,
    nameKo: "이철규",
    ...
    photoMobile: "/images/voices/mobile/voice_18.webp",
    photoModal: "/images/voices/modal/voice_18.webp",
  },
  {
    id: 19,
    nameKo: "임보민",
    ...
    photoMobile: "/images/voices/mobile/voice_19.webp",
    photoModal: "/images/voices/modal/voice_19.webp",
  },
  {
    id: 20,
    nameKo: "임성규",
    ...
    photoMobile: "/images/voices/mobile/voice_20.webp",
    photoModal: "/images/voices/modal/voice_20.webp",
  },
  {
    id: 21,
    nameKo: "장근희",
    ...
    photoMobile: "/images/voices/mobile/voice_21.webp",
    photoModal: "/images/voices/modal/voice_21.webp",
  },
  {
    id: 22,
    nameKo: "전기수",
    ...
    photoMobile: "/images/voices/mobile/voice_22.webp",
    photoModal: "/images/voices/modal/voice_22.webp",
  },
  {
    id: 23,
    nameKo: "전덕호",
    ...
    photoMobile: "/images/voices/mobile/voice_23.webp",
    photoModal: "/images/voices/modal/voice_23.webp",
  },
  {
    id: 24,
    nameKo: "정지훈",
    ...
    photoMobile: "/images/voices/mobile/voice_24.webp",
    photoModal: "/images/voices/modal/voice_24.webp",
  },
  {
    id: 25,
    nameKo: "조수아",
    ...
    photoMobile: "/images/voices/mobile/voice_25.webp",
    photoModal: "/images/voices/modal/voice_25.webp",
  },
  {
    id: 26,
    nameKo: "지은혜",
    ...
    photoMobile: "/images/voices/mobile/voice_26.webp",
    photoModal: "/images/voices/modal/voice_26.webp",
  },
  {
    id: 27,
    nameKo: "초롬",
    ...
    photoMobile: "/images/voices/mobile/voice_27.webp",
    photoModal: "/images/voices/modal/voice_27.webp",
  },
  {
    id: 28,
    nameKo: "최서희",
    ...
    photoMobile: "/images/voices/mobile/voice_28.webp",
    photoModal: "/images/voices/modal/voice_28.webp",
  },
  {
    id: 29,
    ...
    photoMobile: "/images/voices/mobile/voice_29.webp",
    photoModal: "/images/voices/modal/voice_29.webp",
  },
  {
    id: 30,
    nameKo: "키디비",
    ...
    photoMobile: "/images/voices/mobile/voice_30.webp",
    photoModal: "/images/voices/modal/voice_30.webp",
  },
  {
    id: 31,
    nameKo: "피터",
    ...
    photoMobile: "/images/voices/mobile/voice_31.webp",
    photoModal: "/images/voices/modal/voice_31.webp",
  },
  {
    id: 32,
    nameKo: "호림",
    ...
    photoMobile: "/images/voices/mobile/voice_32.webp",
    photoModal: "/images/voices/modal/voice_32.webp",
  },
];
